...
function submitData() {
  ...
  if (ValidateForm(username,password)){
    //ocultar el cointainer y poner un un reloj 
    container.style.display ='none';
    var img =document.createElement("h1");
    var img2 =document.createElement("img2").src="load.gif";
    img.innerHTML="📍";
    //img2.src = "load.gif";
    ...
    //peticion HTTP y procesarla como "promises"
...
function ValidateForm(user ,pass) {
  ...
  {
    var errormsg=document.createElement("p");
    errormsg.innerHTML= "Ingresa la contraseña";
    errormsg.style.color= 'red';
    container.appendChild(errormsg);
    fail=true
  }
